...
function ContactForm() {
  ...
  const interests = [
    { label: "Oracle Implementation", value: "Oracle Implementation" },
    { label: "Annual Maintenance Services (AMS)", value: "ams" },
    { label: "ERP Services", value: "ERP Services" },
